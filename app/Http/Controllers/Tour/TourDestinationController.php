...
class TourDestinationController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        $description = 'Pengguna ' . $request->user()->name . ' menambahkan destinasi wisata dengan tempat/nama wisata: ' . $tour->name;
    ...
    public function edit($id): View
    {
        ...
        return view('dashboard.tour.destinations.edit', compact('tour',  'title'));
    }
    ...
    public function update(Request $request, $id): RedirectResponse
    {
        ...
        $description = 'Pengguna ' . $request->user()->name . ' mengubah destinasi wisata dengan tempat/nama wisata: ' . $tour_destination->name;
    ...
    public function destroy($id): RedirectResponse
    {
        ...
        if ($tour) {
            ...
            $description = 'Pengguna ' . Auth::user()->name  . ' menghapus data destinasi wisata pada tempat/nama wisata: ' . $tour->name;
    ...
    {
        $tour = TourDestination::findOrFail($id);
        $description = 'Pengguna ' . Auth::user()->name  . ' mengunduh data destinasi wisata pada tempat/nama wisata: ' . $tour->name;
        $this->logActivity('tour_destinations', Auth::user(), $tour->id, $description);
