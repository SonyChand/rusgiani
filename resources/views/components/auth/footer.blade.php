            ...
            <div class="row gx-2">
                <div class="col-6">
                    <input class="btn-check" id="navbarPositionVertical" name="navigation-type" type="radio"
                        ...
                        data-page-url="{{ asset('assets') }}/documentation/layouts/vertical-navbar.html"
                        disabled="disabled" />
                ...
                <div class="col-6">
                    <input class="btn-check" id="navbarPositionHorizontal" name="navigation-type" type="radio"
                        ...
                        data-page-url="{{ asset('assets') }}/documentation/layouts/horizontal-navbar.html"
                        disabled="disabled" />
                ...
                <div class="col-6">
                    <input class="btn-check" id="navbarPositionCombo" name="navigation-type" type="radio"
                        ...
                        data-page-url="{{ asset('assets') }}/documentation/layouts/combo-navbar.html" />
                ...
                <div class="col-6">
                    <input class="btn-check" id="navbarPositionTopDouble" name="navigation-type" type="radio"
                        ...
                        data-page-url="{{ asset('assets') }}/documentation/layouts/dual-nav.html" />
            ...
            <div class="row gx-2">
                ...
                <div class="col-6">
                    <input class="btn-check" id="navbarShapeSlim" name="navbar-shape" type="radio" value="slim"
                        ...
                        data-page-url="{{ asset('assets') }}/documentation/layouts/horizontal-navbar.html#horizontal-navbar-slim"
                        disabled="disabled" />
                    <label class="btn d-inline-block btn-navbar-style fs-9" for="navbarShapeSlim"> <span
                            class="mb-2 rounded d-block"><img class="img-fluid img-prototype d-dark-none mb-0"
                                src="{{ asset('assets') }}/assets/img/generic/top-slim.png" alt="" /><img
                                class="img-fluid img-prototype d-light-none mb-0"
                                src="{{ asset('assets') }}/assets/img/generic/top-slim-dark.png"
