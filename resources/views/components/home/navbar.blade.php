<div class="bg-primary-subtle py-2">
    <div class="container-medium d-flex align-items-center justify-content-between">
        @auth
            <a class="btn btn-link p-0 text-body" href="{{ route('dashboard.index') }}"><span
                    class="fa-solid fa-arrow-right-to-bracket me-2" data-fa-transform="down-1"></span>Dashboard</a>
        @else
            <a class="btn btn-link p-0 text-body" href="{{ route('login') }}"><span
                    class="fa-solid fa-arrow-right-to-bracket me-2" data-fa-transform="down-1"></span>Login</a>
        @endauth
        <div class="dropdown">
            <button class="btn btn-sm p-0 d-md-none fs-8" type="button" data-bs-toggle="dropdown"
...
<div class="bg-body-emphasis sticky-top" data-navbar-shadow-on-scroll="data-navbar-shadow-on-scroll">
    <nav class="navbar navbar-landing navbar-expand-lg container-medium"><a
        ...
        <div class="d-flex align-items-center gap-2 gap-sm-3 gap-md-4 my-2 order-lg-1">
            ...
            @auth
                <div class="dropdown">
                    <button class="btn btn-link text-body-tertiary p-0" type="button" id="userDropdown"
                        data-bs-toggle="dropdown" aria-expanded="false">
                        <img src="{{ Auth::user()->picture ? Storage::url(Auth::user()->picture) : asset('assets/assets/img/team/1.webp') }}"
                            alt="User" style="width: 32px; height: 32px; object-fit: cover;" class="rounded-circle">
                    </button>
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                        <li><a class="dropdown-item" href="{{ route('dashboard.index') }}">Dashboard</a></li>
                        <li><a class="dropdown-item" href="{{ route('profiles.edit', Auth::user()->id) }}">Profile</a></li>
                        <li>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mt-3 mt-lg-0">
                <li class="nav-item mx-1 border-bottom border-translucent border-bottom-lg-0"><a
