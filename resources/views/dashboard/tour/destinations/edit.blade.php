    ...
    <div class="row">
        <div class="col-xl-9">
            <form class="row g-3 mb-6 needs-validation" novalidate="" method="POST"
                action="{{ route('tour-destinations.update', $tour->id) }}" onsubmit="showLoader()"
                ...
                <div class="col-sm-12 col-md-12">
                    <div class="form-floating">
                        <input class="form-control" id="name" type="text" name="name"
                            placeholder="Nama/Tempat Wisata" required value="{{ $tour->name }}" />
                ...
                <div class="col-sm-12 col-md-12">
                    ...
                    <textarea class="form-control tinymce" data-tinymce="{}" id="description" name="description" placeholder="Deskripsi"
                        style="height: 250px" required>{{ $tour->description }}</textarea>
                </div>
                <div class="col-sm-12 col-md-12">
                    <div class="form-floating">
                ...
                <div class="col-sm-12 col-md-12">
                    <div class="form-floating">
                        <input class="form-control" id="location" type="text" name="location"
                            placeholder="Google Maps" required value="{{ $tour->location }}" />
