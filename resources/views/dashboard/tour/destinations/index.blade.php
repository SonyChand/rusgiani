<x-dash.layout>
    ...
    <div class="mb-9">
        <div id="touristDestinations"
            data-list='{"valueNames":["id","name", "location", "price"],"page":6,"pagination":true}'>
                    ...
                    <table class="table fs-9 mb-0 border-top border-translucent">
                        <thead>
                            <tr>
                                ...
                                <th class="sort white-space-nowrap ps-0" scope="col" data-sort="description">
                                    Deskripsi</th>
                        ...
                        <tbody class="list" id="destination-list-table-body">
                            ...
                            @foreach ($destinations as $destination)
                                <tr class="position-static">
                                    ...
                                    <td class="time white-space-nowrap ps-0 description py-4">
                                        {{ $destination->description }}</td>
                                    <td class="time white-space-nowrap ps-0 price py-4">{{ $destination->price }}</td>
                                    ...
                                    <td class="time white-space-nowrap ps-0 image py-4">
                                        @if (json_decode($destination->images))
                                            @foreach (json_decode($destination->images) as $image)
                                                <img src="{{ asset('storage/' . $image) }}" alt="Gambar tidak ada"
